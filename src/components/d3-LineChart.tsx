...
import Svg, { Polyline, Path, Defs, LinearGradient, Stop, Text as SvgText, Circle } from "react-native-svg";
    ...
    <View style={{ width: "100%" }}>
      <View style={styles.container} {...panResponder.panHandlers}>
        <Svg width={"100%"} height={height}>
          ...
          {selectedPoint && (
            <Circle
              cx={xScale(lineData.findIndex(d => d.timestamp === selectedPoint.timestamp))}
        ...
        {tooltip && tooltip.isVisible && (
          <View style={[styles.tooltip, { left: tooltip.x - 50, top: tooltip.y - 60 }]}>
            <Text style={styles.tooltipText}>
              {`Date: ${format(new Date(lineData[tooltip.index].timestamp), "MMM d, yyyy HH:mm")}\n`}
      ...
      {selectedPoint && (
        <View style={[styles.dataDisplay, { backgroundColor: `${theme.accent}15`, borderColor: `${theme.accent}40` }]}>
